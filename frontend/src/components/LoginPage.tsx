...
export function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ background: "#F5F4F0", fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif" }}
    >
      <div className="w-full max-w-sm px-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-bold" style={{ color: "#1c1a17", letterSpacing: "-0.5px" }}>Grove</h1>
          <p className="text-sm mt-1" style={{ color: "#a09b94" }}>研究设计助手</p>
        </div>
        ...
        >
          {/* Tab */}
          <div className="flex rounded-lg p-0.5 mb-5" style={{ background: "#F0EDE8" }}>
        ...
        <p className="text-center text-xs mt-4" style={{ color: "#c5c0b8" }}>
