    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-base font-semibold" style={{ color: "#1C1C1C" }}>设置</h2>
          <button onClick={onClose} className="w-7 h-7 flex items-center justify-center rounded-lg transition-colors" style={{ color: "#767676" }}
        ...
        {/* 用户信息 */}
        <div className="mb-5 p-3 rounded-xl" style={{ background: "#F7F7F7" }}>
          <div className="text-xs font-medium mb-0.5" style={{ color: "#5F5F5F" }}>当前账户</div>
          <div className="text-sm font-semibold" style={{ color: "#1C1C1C" }}>{user?.username}</div>
          <div className="text-xs" style={{ color: "#8A8A8A" }}>{user?.email}</div>
        </div>

        {/* API Key */}
        <div className="mb-4">
          <label className="block text-xs font-medium mb-1" style={{ color: "#5F5F5F" }}>
            自定义 API Key
          </label>
          <p className="text-xs mb-2.5 leading-relaxed" style={{ color: "#8A8A8A" }}>
        ...
        <button
          ...
          style={{ background: saved ? "#27AE60" : PRIMARY }}
        >
